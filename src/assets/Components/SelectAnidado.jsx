...
const SelectAnidado = () => {
  ...
  const TOKEN='c724f34b-07e7-46b5-91f3-080183d957a5'
  return (
    <>
      <p>Select Anidados</p>
      <br />
      ...
      {departamento && (
        <SelectList
          ...
          url={`https://api.copomex.com/query/get_municipio_por_estado/${departamento}?token=${TOKEN}`}
        ></SelectList>
      )}
      <br />
      <br />
      {provincia && (
        <SelectList
          ...
          url={`https://api.copomex.com/query/get_colonia_por_municipio/${provincia}?token=${TOKEN}`}
        ></SelectList>
      )}
    </>
  );
...
/* {dep.map((departamento)=><p>{departamento.nombre_ubigeo} {departamento.codigo_ubigeo}</p>)} */

//  TOKEN: d81a7ac7-976d-4e1e-b7d3-b1979d791b6c
